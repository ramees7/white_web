...
// import oudhThumbnail from "../../assets/oudh-2.jpg";
// import capsThumbnail from "../../assets/caps.jpg";
// import kidsThumbnail from "../../assets/kids-cate.jpg";
...
//     {
//       title: "Kids",
//       thumbnail: kidsThumbnail,
//       description: "Comfortable and premium-quality kids wear.",
//       link: "",
//     },
//     {
//       title: "Inner Wear",
...
//       <div className="h-[400px] relative ">
//         <div
//           className="fixed top-0 left-0 w-full h-screen -z-20 bg-cover bg-center"
//           style={{ backgroundImage: `url(${categoryList[2].thumbnail})` }}
//         >
//           <div className="absolute inset-0 bg-black opacity-30"></div>
//         </div>
//         <div className="flex flex-col gap-6 justify-center items-center h-full">
...
//         }`}
//       >
//         {categoryList.slice(3, 5).map((category, index) => (
//           <div
//             className={`grid md:grid-cols-2 gap-5 md:gap-0 ${
//               index === 0 ? "" : "md:mt-0 mt-10"
//             } h-fit `}
...
//         <div
//           className="fixed top-0 left-0 w-full h-screen -z-10 bg-cover bg-center"
//           style={{ backgroundImage: `url(${categoryList[5].thumbnail})` }}
//         >
//           <div className="absolute inset-0 bg-black opacity-30"></div>
//         </div>
//         <div className="flex flex-col gap-6 justify-center items-center h-full">
//           <div className={`text-white text-center`}>
//             <h1 className={`md:text-5xl text-3xl font-semibold uppercase `}>
//               {categoryList[5].title}
//             </h1>
//             <h3 className="text-sm md:text-base">
//               {categoryList[5].description}
//             </h3>
//           </div>
//           <button
//             className={`px-8 py-2  text-base uppercase ${
